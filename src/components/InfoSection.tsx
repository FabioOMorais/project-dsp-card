...
const InfoSection = () => {
  const handleCopyEmail = () => {
    navigator.clipboard.writeText("negocios.publico@desenvolvesp.com.br");
    toast({
      title: "E-mail copiado!",
      description: "negocios.publico@desenvolvesp.com.br foi copiado.",
    });
  };
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="flex flex-col gap-12 max-w-md mx-auto w-full">
            ...
            {/* 1 — CARD DO BILLY ● SEMPRE PRIMEIRO */}
                ...
                <div className="space-y-0">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-primary shadow-md shrink-0">
                      <img
                        src="/billy.png"
                        alt="Foto de Billy Rod"
                        className="w-full h-full object-cover"
                      />
                    </div>

                    <div>
                      <h4 className="font-bold text-xl">Billy Rod</h4>
                      <p className="text-muted-foreground">
                        Gerente do Setor Público
                      </p>
                    </div>
                  </div>
            ...
            <div className="order-4 lg:order-3 space-y-6 pt-6 w-full">
              ...
              <div className="grid gap-5">
                ...
                <ResourceCard
                  ...
                  link="https://www.desenvolvesp.com.br/wp-content/uploads/2025/02/Kit-Padrao.zip"
                />

                <ResourceCard
                  icon={Video}
                  title="Playlist de Projetos"
                  description="Veja como a Desenvolve SP está transformando municípios paulistas."
          ...
          <div className="space-y-12 order-3 lg:order-none">
            ...
            <div className="space-y-4 animate-fade-in">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Se você é um gestor público e procura recursos para tirar seus projetos do papel e transformar sua cidade em uma história de sucesso, conte com a Desenvolve SP.
              </p>
            ...
            <div className="space-y-6">
              <FinancingCard
                ...
                link="https://www.desenvolvesp.com.br/municipios/opcoes-de-credito/linha-municipios-sustentaveis/"
              />
              ...
              <FinancingCard
                ...
                link="https://www.desenvolvesp.com.br/municipios/opcoes-de-credito/linha-de-apoio-investimentos-municipais/"
              />
            </div>
