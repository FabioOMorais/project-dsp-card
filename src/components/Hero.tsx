    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 pb-32 sm:pb-20 text-center animate-slide-up">
        ...
        <div className="flex justify-center mb-8">
          <img
            src={logosJunto}
            alt="Desenvolve SP e Desenvolvimento Econômico"
        ...
        <p className="text-lg md:text-xl text-white/95 max-w-4xl mx-auto mb-12 font-normal">
          A Desenvolve SP, agência de fomento do Governo de São Paulo, apoia os municípios
          na construção de um futuro mais sustentável e inovador.
        </p>
      ...
      >
        <a
          href="https://www.desenvolvesp.com.br/municipios/"
          target="_blank"
        ...
        <a
          href="https://www.instagram.com/desenvolvesp/"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-white/10 backdrop-blur-sm p-3 rounded-full hover:bg-white/20 transition-all hover:scale-110"
        >
        ...
        <a
          href="https://www.facebook.com/agenciadesenvolvesp"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-white/10 backdrop-blur-sm p-3 rounded-full hover:bg-white/20 transition-all hover:scale-110"
        >
