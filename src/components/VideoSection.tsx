      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        <div className="text-center mb-14 space-y-4 max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-x text-white/70">
            Veja como a Desenvolve SP está transformando municípios paulistas através
            de investimentos em infraestrutura, educação, saúde e desenvolvimento econômico.
          </p>
